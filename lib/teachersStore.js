...
export const INITIAL_TEACHERS = [
  ...
  {
    id: 'tch-201',
    institutionSlug: 'nitk-surathkal',
    institutionCode: 'NITK-02',
    teacherId: 'EMP-NIT-201',
    name: 'Dr. Rajesh Bhattacharya',
    email: 'rajesh.bhatt@nitk.edu.in',
    ...
    assignedCourses: [
      { id: 'crs-4', code: 'IT-301', title: 'Computer Networks', semester: 'Semester 5', totalStudents: 70 }
    ]
  }
];
...
export function getTeachersByInstitution(slug) {
  ...
  return teachers.filter(t => t.institutionSlug === slug || t.institutionCode?.toLowerCase() === slug.toLowerCase());
}
